...
def analyze_deal(normalized_deal: dict[str, Any], config: DealAnalyzerConfig) -> DealAnalysis:
    ...
    _push_flag(has_presentation, strong_sides, growth_zones, "???? ???????? ???????????", "??? ????????????? ???????????")
    _push_flag(has_brief, strong_sides, growth_zones, "???????? ????", "??? ?????")
    _push_flag(has_demo, strong_sides, growth_zones, "???? ????????? ????", "??? ?????????? ????")
    _push_flag(has_pain, strong_sides, growth_zones, "????????????? ???? ???????", "?? ??????? ???? ???????")
    _push_flag(has_business_tasks, strong_sides, growth_zones, "???? ??????-?????? ???????", "?? ????????? ??????-??????")
    _push_flag(has_followup_tasks, strong_sides, growth_zones, "???? follow-up ??????????", "??? follow-up ?????")
    _push_flag(has_product_fit, strong_sides, growth_zones, "???? ??????????? fit", "?? ????????? product fit")
    _push_flag(has_probability, strong_sides, growth_zones, "??????? ??????????? ??????", "?? ??????? ??????????? ??????")

    if empty_context_with_movement:
        risk_flags.append("???? ???????? ?? ?????? ??? ?????? notes/tasks/comments")
