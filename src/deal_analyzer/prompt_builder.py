...
def build_call_review_case_messages(
    *,
    ...
    user_prompt = (
        ...
        "7) Если критикуешь конкретную фразу менеджера, обязательно дай улучшенную формулировку дословно.\n"
        "8) В stage_*_comment добавляй короткую цитату в кавычках и сразу управленческий вывод.\n\n"
